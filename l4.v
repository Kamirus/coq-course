...
które można stosować w dowolnym podtermie danego termu.  Następnie
zdefiniuj relację normalizacji jako zwrotno-przechodnie domknięcie
relacji redukcji.

3. Zdefiniuj typ danych reprezentujący typy proste z jednym typem
bazowym.
